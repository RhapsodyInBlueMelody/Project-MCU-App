...
<head>
    ...
    <meta name="description" content="Medical Check Up Portal for Patients">
    ...
    <link rel="stylesheet" href="<?= base_url("assets/css/patient.min.css") ?>">
            ...
            <ul class="space-y-2 p-4">
                ...
                <li>
                    <a href="<?= base_url(
                        ...
                        <i class="fas fa-history mr-2" aria-hidden="true"></i> Riwayat Medical Check Up
                    </a>
                </li>
