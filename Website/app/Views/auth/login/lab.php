...
<head>
    <title>Medical Checkup - Login Petugas Lab</title>
    <meta charset="UTF-8">
        ...
        <div class="max-w-md w-full bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="p-6">
                ...
                <form action="<?= base_url(
                    ...
                    <input type="hidden" name="role" value="petugas_lab">
                    <div class="mb-4">
                ...
                <div class="text-center mt-6">
                    <p class="text-sm text-gray-600">
                        Belum memiliki akun?
                        <a href="<?= base_url(
                                        "auth/register/social/petugas_lab"
